...
/*   Updated: 2017/05/20 19:34:38 by mdubus           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			backslash_in_buffer(char *buffer, int length, t_dlist **mew,
			char **line)
{
	char	*temp;
	size_t	n;
...
int			backslash_in_rest(int fd, char **line, t_dlist **mew, char **buffer)
{
	size_t		n;
	char		*temp;
	t_dlist		*mew2;
